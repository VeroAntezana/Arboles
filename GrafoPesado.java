        ...
        validarVertice(posVerticeAEliminar);
          ...
          for (List<AdyacenteConPeso> adyacentesDeVertice : this.ListaDeAdyacencias){
              ...
              for (int i =0; i < adyacentesDeVertice.size(); i++){
                   List<AdyacenteConPeso> adyacentesDelDestino = this.ListaDeAdyacencias.get(i);    //Prguntar si esta bien
            AdyacenteConPeso adyacenciaAlDestino = new AdyacenteConPeso(posVerticeAEliminar, 0);      //igual 
                  int posicionDeAdyacente = adyacentesDeVertice.get(adyacenciaAlDestino);
